...
@then(u'vejo a promococao da semana')
def step_impl(context):
    ...
    assert context.driver.find_element(By.XPATH, '//body/div[2]/img[1]').get_attribute('src') == 'https://www.blazedemo.com/assets/vacation.jpg'